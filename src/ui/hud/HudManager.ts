...
export class HudManager {
   ...
   * angle (Babylon ArcRotateCamera.alpha). 0 ≈ looking along +X.
   */
  updateCompass(cameraYawRadians: number) {
    ...
    const offset = (headingDeg / 360) * stripWidth;
    ...
    void offset; // reserved for future smooth-scroll mode
  }
